package es.carlosmilena.androidfirebase.utilidades;

import static es.carlosmilena.androidfirebase.utilidades.ImagenesBlobBitmap.bytes_to_bitmap;
...
public class ImagenesFirebase{
	public static void subirFoto(String nombre_carpeta, String nombre, ImageView img_add_foto){
		...
		StorageReference foto2Ref = storageRef.child(
				nombre_carpeta + "/" + String.valueOf(nombre) + ".png");
	...
	public static void descargarFoto(String nombre_carpeta, String nombre,
                                     ImageView imagendescargada){
		FirebaseStorage storage = FirebaseStorage.getInstance();
		StorageReference storageRef = storage.getReference();
		StorageReference islandRef = storageRef.child(nombre_carpeta + "/" + nombre + ".png");
		final long tam_foto = 10240 *
							  1024; // tamaño máximo de la descarga de la imagen, si es mayor la
        // descarga falla.
